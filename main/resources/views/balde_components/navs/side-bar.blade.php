<nav class="side-bar bg-gray-600" id="side-bar" >
    ...
    <div class="links">
        <ul>
            ...
            <li><a href="/restaurants"><i class="fas fa-store "></i> &nbsp; {{__("Restaurants")}}</a></li>
            <li><a href="/foods"> <i class="fas fa-utensils "></i> &nbsp; {{__("Foods")}}</a></li>
