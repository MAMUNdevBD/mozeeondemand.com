<form class="mt-4"  method="POST" action="/register">
    ...
    {{-- Login with socialite --}}
        ...
        <div class="flex flex-col mt-1">
            <a href="#" class="flex-1 flex-row px-2 py-2.5 text-center bg-red-500  my-1 text-white rounded h-14 items-center"><i class="fab fa-google"></i>{{__('Sign in with google')}} </a>
            <a href="#" class="flex-1 flex-row px-2 py-2.5 text-center bg-blue-600 my-1 text-white rounded h-14 items-center"><i class="fab fa-facebook"></i> <span class="text-sm md:text-base">{{__('Sign in with Facebook')}}</span></a>
        </div>
