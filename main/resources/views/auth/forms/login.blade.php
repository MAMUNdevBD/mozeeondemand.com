<form  class="mt-8" method="POST" action="/login">
    ...
    {{-- Login with socialite --}}
        ...
        <div class="flex flex-col  my-3">
            ...
            <a href="#" class="flex-1 flex-row px-2 py-2.5 text-center bg-blue-600 my-1 text-white rounded h-14 items-center"><i class="fab fa-facebook"></i> <span class="text-sm md:text-base"> 
