...
@section('content')
    ...
    <main class="w-full min-h-screen mt-16  relative  flex flex-row justify-center py-10" >
        <div class="w-full container md:w-5/6  lg:w-3/4 ">
            <form class="w-full rounded mb-3 shadow-lg" method="POST" action="/review">
                @csrf
                ...
                <div class="bg-gray-50 dark:bg-gray-800 grid grid-cols-4 gap-6  p-4 rounded-b-sm" > 
                    ...
                    <div class="md:col-span-4 col-span-4 text-gray-800 dark:text-white text-sm font-semibold mb-1">
                        ...
                        <div class="slider-container  py-2 ">
                            ...
                            <input type="range" required id="quality" name="rate" class=" range_v2 slider relative z-20 appearance-none border-1 border-gray-300 -mt-2 w-full h-2 rounded outline-none  bg-transparent " 
